...
func (in *AWSECRContainerImageDetails) DeepCopyInto(out *AWSECRContainerImageDetails) {
	*out = *in
	if in.LastInUseAt != nil {
		in, out := &in.LastInUseAt, &out.LastInUseAt
		*out = (*in).DeepCopy()
	}
	if in.PushedAt != nil {
...
func (in *PackageVulnerabilityDetails) DeepCopyInto(out *PackageVulnerabilityDetails) {
	*out = *in
	...
	if in.VendorCreatedAt != nil {
		in, out := &in.VendorCreatedAt, &out.VendorCreatedAt
		*out = (*in).DeepCopy()
	}
	if in.VendorUpdatedAt != nil {
		in, out := &in.VendorUpdatedAt, &out.VendorUpdatedAt
		*out = (*in).DeepCopy()
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RepositoryCreationTemplate_SDK) DeepCopyInto(out *RepositoryCreationTemplate_SDK) {
	*out = *in
	if in.AppliedFor != nil {
		in, out := &in.AppliedFor, &out.AppliedFor
		*out = make([]*string, len(*in))
...
func (in *RepositoryCreationTemplate_SDK) DeepCopy() *RepositoryCreationTemplate_SDK {
	if in == nil {
		return nil
	}
	out := new(RepositoryCreationTemplate_SDK)
	in.DeepCopyInto(out)
	return out
}
