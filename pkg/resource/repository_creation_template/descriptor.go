...
var (
	// GroupVersionKind is the GroupVersionKind for RepositoryCreationTemplate
	GroupVersionKind = svcapitypes.GroupVersion.WithKind("RepositoryCreationTemplate")

	// GroupKind is the GroupKind for RepositoryCreationTemplate
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.RepositoryCreationTemplate{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(obj rtclient.Object) acktypes.AWSResource {
	return newResource(nil, obj.(*svcapitypes.RepositoryCreationTemplate))
}
