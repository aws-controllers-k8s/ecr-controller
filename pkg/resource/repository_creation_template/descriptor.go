...
const (
	FinalizerString = "finalizers.ecr.services.k8s.aws/RepositoryCreationTemplate"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("repositorycreationtemplates")
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.RepositoryCreationTemplate),
	}
}
