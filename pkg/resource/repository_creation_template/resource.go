...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.Prefix = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["prefix"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: prefix"))
	}
	r.ko.Spec.Prefix = &primaryKey
