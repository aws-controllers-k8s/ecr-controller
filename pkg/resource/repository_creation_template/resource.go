...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	// Use NameOrID as RepositoryNamePrefix for RepositoryCreationTemplate
	r.ko.Spec.RepositoryNamePrefix = &identifier.NameOrID
	return nil
}

// PopulateResourceFromAnnotation populates the fields passed from adoption annotation
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["repositoryNamePrefix"]
	if !ok {
		return fmt.Errorf("required field missing: repositoryNamePrefix")
	}
	r.ko.Spec.RepositoryNamePrefix = &primaryKey
	return nil
}
...
func newResource(
	rr acktypes.AWSResourceReconciler,
	c *svcapitypes.RepositoryCreationTemplate,
