...
const (
	finalizerString = "finalizers.ecr.services.k8s.aws/PullThroughCacheRule"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("pullthroughcacherules")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.PullThroughCacheRule{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PullThroughCacheRule),
	}
}
