...
// +kubebuilder:rbac:groups=ecr.services.k8s.aws,resources=pullthroughcacherules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecr.services.k8s.aws,resources=pullthroughcacherules/status,verbs=get;update;patch
